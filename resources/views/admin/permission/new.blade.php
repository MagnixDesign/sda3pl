<div class="box-header with-border">
    ...
    <div class="box-tools pull-right">
        <button type="button" class="btn btn-primary btn-sm" id="btn-new-permission"><i class="fa fa-plus-circle"></i> New </button>
...
<div class="box-body" style="min-height:100px">
    <div class="row">
        <div class="col-md-12 col-lg-12">
            ...
            <span class="badge bg-purple">{!! User::count('permission') !!}</span>
